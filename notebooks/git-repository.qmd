...
There are two basic ways initialising a repository

1. Initialise a new repository using git directly
...
:::callout-note
There is nothing stopping you creating a repository on a shared drive.
In fact, this is a useful first exercise that we will look at in the collaboration part of this workshop.
:::
