...
> "I am no expert (in git *et al*) but I know enough to both get myself into trouble and usually find a way out of it."


Note that you are likely to find some of this knowledge base hard and/or frustrating.
The work purposefully (and unapologetically) takes a low level perspective on git.
The rationale stems from experience of this being the best way to build a clear and coherent understanding.

Think of it this way, if you didn't understand what letters and words are, you are probably going to have a hard job of understanding how to *cunstrucked a sentunse*.

Often people get themselves in a mess simply as a result of not understanding the fundamentals.
Therefore, the goal here is to understand the fundamental aspects of revision control and git in particular.
Once you have that base, extending from there will be much easier for you.

The pace of the workshop will be based on the abilities of the audience but there is an expectation that the audience practices the skills.
...
People outside of software development and analysts find the command line arcane, but it provides an extremely useful set of tools that pay dividends if you make the effort to learn.
