...
You are likely^[Actually with very high probability. Sorry.] going to find some^[Probably a lot.] of this text hard and/or frustrating and/or/also painful.

Your knowledge will progress in a stepwise fashion^[Monotonically, I am sure. Ideally strictly positively.] through setup, core concepts and collaboration.
...
The goal here is for you to gain understanding into the fundamental aspects of revision control and [`git`](https://git-scm.com/) in particular.
...
For the purposes here, you can treat all these terms as synonomous.
